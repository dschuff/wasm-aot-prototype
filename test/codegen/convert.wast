...
;; CHECK: uitofp i64 %get_local{{.+}} to double
    (f32.demote/f64 (get_local 3))
;; CHECK: fptrunc double %get_local{{.+}} to float
    (f64.promote/f32 (get_local 2))))
