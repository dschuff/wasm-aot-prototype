...
;;(assert_return (invoke "shl" (i32.const 1) (i32.const 32)) (i32.const 0))
;;(assert_return (invoke "shl" (i32.const 1) (i32.const 33)) (i32.const 0))
;;(assert_return (invoke "shl" (i32.const 1) (i32.const -1)) (i32.const 0))
;;(assert_return (invoke "shl" (i32.const 1) (i32.const 0x7fffffff)) (i32.const 0))
...
;;(assert_return (invoke "shr_s" (i32.const 1) (i32.const 32)) (i32.const 0))
...
;;(assert_return (invoke "shr_s" (i32.const 1) (i32.const 0x80000000)) (i32.const 0))
...
;;(assert_return (invoke "shr_u" (i32.const 1) (i32.const 32)) (i32.const 0))
...
;;(assert_return (invoke "shr_u" (i32.const 1) (i32.const 0x80000000)) (i32.const 0))
